    ...
    <div className="container">
      ...
      <div className="footer-links-wrapper row">
        <div className="links-wrapper-1 col-sm-12 col-md">
          <h3 data-toggle="collapse" data-target="#shopAndLearnCollapse" aria-expanded="false" aria-controls="shopAndLearnCollapse">Shop and Learn</h3>
          <div id="shopAndLearnCollapse" className="collapse" >
          <ul>
            <li>
              <a href="#">Mac</a>
            </li>
